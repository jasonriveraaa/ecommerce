            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    if (isset($_POST['btn_save'])) {
                        ...
                        $sql = "INSERT INTO tbl_item (name,collection,category_id,color,price,img,hover_img) VALUE ('$name','$collection','$category','$color','$price','$image','$hover_image')";
                        ...
                        if ($result) {
                            ...
                            move_uploaded_file($hover_image_temp, "../assets/img/$image");
                        } else {
                            $failed_msg = "Error";
                    ...
                    <div class="modal-body">
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="inputZip" name="form_price">
                            </div>
                            <div class="col-12">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            ?>
                            <td><img src="../assets/img/<?php echo $product_img ?>" width="50" alt=""></td>
